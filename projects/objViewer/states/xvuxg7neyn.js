let xvuxg7neyn = {
    ...
    "graph": {
      "viewport": {
        "xmin": -1.6354506269020375,
        "ymin": -1.6354506269020375,
        "xmax": 1.6354506269020375,
        "ymax": 1.6354506269020375
      },
      "showGrid": false,
      "showXAxis": false,
      "showYAxis": false,
    ...
    "expressions": {
      "list": [
        ...
        },
        {
          ...
          "folderId": "1095",
          "color": "#2d70b3",
          "latex": "p_{d}\\left(v\\right)=\\left[\\frac{m_{4}\\left(P,v\\right)\\left[1\\right]}{m_{4}\\left(P,v\\right)\\left[4\\right]},\\frac{m_{4}\\left(P,v\\right)\\left[2\\right]}{m_{4}\\left(P,v\\right)\\left[4\\right]},\\frac{m_{4}\\left(P,v\\right)\\left[3\\right]}{m_{4}\\left(P,v\\right)\\left[4\\right]},m_{4}\\left(P,v\\right)\\left[4\\right]\\right]"
        },
        {
          "type": "folder",
          "id": "1366",
